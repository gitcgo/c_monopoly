...
pion::pion() {
	Position = depart; //Le pion est forcément situé à la case départ lors de sa création. On include "case" dans pion.h et la case depart est fille de Case donc pas de soucis
