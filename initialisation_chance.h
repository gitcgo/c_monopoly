...
Carte* initialisation_chance(Plateau plateau) {
	...
	pile_carte_chance[2] = Carte("Rendez-vous au Boulevard de la Villette",0,0,0,plateau.getCase(11)); // NULL à remplacer par case 11 du plateau
	...
	pile_carte_chance[5] = Carte("Rendez-vous à la rue Henri Martin ",0,0,0,plateau.getCase(24));// dernier null à remplacer par la case 24 du plateau
	pile_carte_chance[6] = Carte("Rendez-vous à la gare de Lyon",0,0,0,plateau.getCase(15)); // replace null => 15
